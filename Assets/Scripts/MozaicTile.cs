...
public class MozaicTile : MonoBehaviour {
...
//	}
	public void Initialize(int newWidthSubdivisions, int newHeightSubdivisions)
	{
		...
		//Material:
		screenMaterial.mainTextureScale = new Vector2(widthSubdivisions, heightSubdivisions);

		//Texture itself:
		screenTexture = new Texture2D( tileWidth, tileHeight);
